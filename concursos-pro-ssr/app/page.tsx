...
export const metadata = {
  ...
  description: "Lista atualizada de concursos públicos e seletivos abertos no Maranhão em 2026. Confira salários, bancas organizadoras e detalhes dos editais.",
  keywords: [
  ...
  if (error) {
    ...
    return (
      <main className="min-h-screen bg-[#0f172a] text-white flex items-center justify-center p-5">
        <div className="text-center p-10 bg-white/5 border border-red-500/20 rounded-xl max-w-md">
          <p className="text-red-400 font-bold text-lg mb-2">Erro ao carregar concursos 😢</p>
          <p className="text-slate-400 text-sm mb-4">Estamos ajustando a conexão com a base de dados. Tente novamente em instantes.</p>
          <Link href="/" className="inline-block bg-white/10 px-4 py-2 rounded-lg text-sm text-slate-200 hover:bg-white/20 transition">
            Atualizar página
          </Link>
        </div>
      </main>
    ...
    <main className="min-h-screen bg-[#0f172a] text-white font-sans">
      ...
      <section className="max-w-6xl mx-auto p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {lista.length === 0 && (
            <div className="col-span-full text-center text-slate-400 mt-10 p-8 border border-dashed border-white/10 rounded-xl">
